    ...
    public class DotNetFileSystemSpecs
    {
        public abstract class DotNetFileSystemSpecsBase : TinySpec
        {
            ...
            public override void Context()
            {
                ...
                ContextPath = Path.Combine(TestContext.CurrentContext.TestDirectory, "infrastructure", "filesystem");
        ...
        public class when_doing_file_system_operations_with_dotNetFileSystem : DotNetFileSystemSpecsBase
        {
            ...
            {
                FileSystem.directory_exists(Path.Combine(TestContext.CurrentContext.TestDirectory, "IDontExist")).Should().BeFalse();
            }
