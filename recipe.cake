    ...
    .Does(() =>
{
    ...
    CopyFile(BuildParameters.Paths.Directories.PublishedApplications + "/choco/net7.0/choco.exe", BuildParameters.Paths.Directories.ChocolateyNuspecDirectory + "/tools/chocolateyInstall/choco.exe");
    ...
    .Does(() =>
{
    ...
    // Run Chocolatey Unpackself
    CopyFile(BuildParameters.Paths.Directories.PublishedApplications + "/choco-no7zip/choco.exe", nuspecDirectory + "/tools/chocolateyInstall/choco.exe");
...
Task("Prepare-NuGet-Packages")
    ...
    .Does(() =>
{
    CleanDirectory(BuildParameters.Paths.Directories.NuGetNuspecDirectory + "/lib/net7.0");
    EnsureDirectoryExists(BuildParameters.Paths.Directories.NuGetNuspecDirectory + "/lib/net70");
    ...
    CopyFiles(BuildParameters.Paths.Directories.PublishedLibraries + "/chocolatey/net7.0/*", BuildParameters.Paths.Directories.NuGetNuspecDirectory + "/lib/net70");
    CopyFile(BuildParameters.Paths.Directories.PublishedLibraries + "/chocolatey/net7.0/chocolatey.xml", BuildParameters.Paths.Directories.NuGetNuspecDirectory + "/lib/net70/chocolatey.xml");
});
